function Types12BifDiagFullVaryPhiE2
...
OneoverThetaPhiE_lin = linspace(0.683, 0.686, N_OneoverThetaPhiE_lin); % Good
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PING_Types12Tau04BifDiagFullVaryPhiE2.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
