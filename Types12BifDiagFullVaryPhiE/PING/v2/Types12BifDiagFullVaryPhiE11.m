...
OneoverThetaPhiE_lin = linspace(0.710, 0.8, N_OneoverThetaPhiE_lin); % Good
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PING_Types12Tau04BifDiagFullVaryPhiE11.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
