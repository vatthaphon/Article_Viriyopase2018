function Types12BifDiagFullVaryPhiE9
...
OneoverThetaPhiE_lin = linspace(0.704, 0.707, N_OneoverThetaPhiE_lin); % Good
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PING_Types12Tau04BifDiagFullVaryPhiE9.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
