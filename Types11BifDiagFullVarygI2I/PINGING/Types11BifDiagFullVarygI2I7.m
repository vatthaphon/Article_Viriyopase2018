...
N_epsilonII_lin = 100;
epsilonII_lin = linspace(-0.6, -0.4, N_epsilonII_lin);
...
save('PINGING_Types11BifDiagFullVarygI2I7.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonII_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonEI', 'epsilonIE', 'tau');    
