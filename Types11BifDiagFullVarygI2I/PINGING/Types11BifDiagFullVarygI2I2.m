...
N_epsilonII_lin = 100;
epsilonII_lin = linspace(-1.6, -1.4, N_epsilonII_lin);
...
save('PINGING_Types11BifDiagFullVarygI2I2.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonII_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonEI', 'epsilonIE', 'tau');    
