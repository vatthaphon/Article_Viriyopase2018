...
N_epsilonII_lin = 100;
epsilonII_lin = linspace(-2.0, -1.8, N_epsilonII_lin);
...
save('PINGING_Types11BifDiagFullVarygI2I0.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonII_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonEI', 'epsilonIE', 'tau');    
