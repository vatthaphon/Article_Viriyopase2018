...
hSurface = surf(OneoverThetaPhiE_lin, OneoverThetaPhiI_lin, PINGING_sce4_f1');set(hSurface,'FaceColor',[20/255 156/255 73/255],'FaceAlpha', 0.95, 'EdgeColor', 'none');
...
hSurface = surf(OneoverThetaPhiE_lin, OneoverThetaPhiI_lin, PINGING_f2');set(hSurface,'FaceColor',[167/255 212/255 140/255],'FaceAlpha', 0.7, 'EdgeColor', 'none');
...
% ylabel('I');
maximize_a_fig(gcf);
m_savefig('Types11BifDiagFullVaryPhiEPhiI_printing', 'eps');
