...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('ING_Types11BifDiagFullVaryPhiE1.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
