function Types12BifDiagFullVaryPhiI2
...
OneoverThetaPhiI_lin = linspace(0.502, 0.503, N_OneoverThetaPhiI_lin);
...
for OneoverThetaPhiI = OneoverThetaPhiI_lin
    ...
    save('PING_Types12Tau04BifDiagFullVaryPhiI2.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
