...
for epsilonII = epsilonII_lin
    ...
    save('ING_Types12Tau04BifDiagFullVarygI2I6.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonII_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonIE', 'epsilonEI', 'tau');
end
