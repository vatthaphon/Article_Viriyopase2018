...
N_epsilonII_lin = 100;
epsilonII_lin = linspace(-0.3, -0.2, N_epsilonII_lin);
...
for epsilonII = epsilonII_lin
    ...
    save('PINGING_Types12Tau04BifDiagFullVarygI2I7.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonII_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonIE', 'epsilonEI', 'tau');
end
