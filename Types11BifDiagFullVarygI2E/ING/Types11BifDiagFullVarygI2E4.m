...
save('ING_Types11BifDiagFullVarygI2E4.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonEI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'tau');    
