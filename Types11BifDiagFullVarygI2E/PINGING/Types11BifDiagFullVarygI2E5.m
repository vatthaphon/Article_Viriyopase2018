function Types11BifDiagFullVarygI2E0
...
N_epsilonEI_lin = 100;
epsilonEI_lin = linspace(-0.5, -0.4, N_epsilonEI_lin);
...
thetaPhiI = 1/0.532;  % Phase threshold
I_I = (gammaI*thetaVI)./(1 - exp(-gammaI*thetaPhiI));    

f1 = NaN(1, N_epsilonEI_lin);
f2 = NaN(1, N_epsilonEI_lin);
f3 = NaN(1, N_epsilonEI_lin);
f4 = NaN(1, N_epsilonEI_lin);
f5 = NaN(1, N_epsilonEI_lin);

f_i = 0;
for epsilonEI = epsilonEI_lin    
...
save('PINGING_Types11BifDiagFullVarygI2E5.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonEI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'tau');    
