...
N_epsilonEI_lin = 100;
epsilonEI_lin = linspace(-1.0, -0.9, N_epsilonEI_lin);
...
save('PINGING_Types11BifDiagFullVarygI2E0.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonEI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiI', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'tau');    
