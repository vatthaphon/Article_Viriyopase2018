function plotTypes11BifDiagFullVaryPhiE_v1_play
clc;
clear all;
close all;
...
%     plot(OneoverThetaPhiE_lin, f5, 'b*');
    ...
    figure(1);
    plot(OneoverThetaPhiE_lin, f1, 'r*');
    plot(OneoverThetaPhiE_lin, f2, 'g*');   % Top lines
    plot(OneoverThetaPhiE_lin, f3, 'b*');   % Top lines    
    plot(OneoverThetaPhiE_lin, f4, 'k*');   % Buttom lines
...
plot(OneoverThetaPhiE_total, f2_total, 'g*');
plot(OneoverThetaPhiE_total, f3_total, 'b*');
plot(OneoverThetaPhiE_total, f4_total, '-', 'LineWidth', 4, 'Color', [101/255 163/255 92/255]);
% % plot(OneoverThetaPhiE_total, f5_total, 'y*');
