function Types11BifDiagFullVaryPhiE3
clc; clear all; 
% close all
...
OneoverThetaPhiE_lin = linspace(0.488, 0.492, N_OneoverThetaPhiE_lin);
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PINGING_Types11BifDiagFullVaryPhiE3.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
