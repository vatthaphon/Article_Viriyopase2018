function Types11BifDiagFullVaryPhiE7
clc; clear all; 
% close all
...
OneoverThetaPhiE_lin = linspace(0.504, 0.508, N_OneoverThetaPhiE_lin);
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PINGING_Types11BifDiagFullVaryPhiE7.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
