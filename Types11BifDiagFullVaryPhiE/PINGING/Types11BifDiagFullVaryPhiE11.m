function Types11BifDiagFullVaryPhiE10
clc; clear all; 
% close all
...
if (1 > epsilonIE)
    thetaPhiI = 1/0.495;   % Phase threshold
else
    thetaPhiI = 10;   % Phase threshold
end
...
OneoverThetaPhiE_lin = linspace(0.520, 0.600, N_OneoverThetaPhiE_lin);

f1 = NaN(1, N_OneoverThetaPhiE_lin);
f2 = NaN(1, N_OneoverThetaPhiE_lin);
f3 = NaN(1, N_OneoverThetaPhiE_lin);
f4 = NaN(1, N_OneoverThetaPhiE_lin);
f5 = NaN(1, N_OneoverThetaPhiE_lin);
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PINGING_Types11BifDiagFullVaryPhiE11.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
