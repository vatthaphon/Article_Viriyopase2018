function Types11BifDiagFullVaryPhiE8
clc; clear all; 
% close all
...
OneoverThetaPhiE_lin = linspace(0.508, 0.512, N_OneoverThetaPhiE_lin);
...
for OneoverThetaPhiE = OneoverThetaPhiE_lin
    ...
    save('PINGING_Types11BifDiagFullVaryPhiE8.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiE_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
