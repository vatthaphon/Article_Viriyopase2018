...
for epsilonEI = epsilonEI_lin
    ...
    save('PINGING_Types12Tau04BifDiagFullVarygI2E3.mat', 'phiI', 'phiE', 'f51', 'f15', 'f5', 'f4', 'f3', 'f2', 'f1', 'epsilonEI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonIE', 'epsilonII', 'tau');
end
