function INGTypes12BifDiagFullVaryPhiE1
...
OneoverThetaPhiI_wholelin = linspace(1/ThetaPhiI_max, 1/ThetaPhiI_min, 11);
...
for OneoverThetaPhiI = OneoverThetaPhiI_lin
    ...
    FN = strcat('ING_Types12Tau04BifDiagFullVaryPhiI', num2str(cur_fileID), '.mat');
    save(FN, 'phiI', 'phiE', ...
