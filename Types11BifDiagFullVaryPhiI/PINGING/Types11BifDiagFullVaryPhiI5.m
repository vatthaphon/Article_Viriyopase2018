function Types11BifDiagFullVaryPhiI5
...
OneoverThetaPhiI_lin = linspace(0.490, 0.500, N_OneoverThetaPhiI_lin);
...
for OneoverThetaPhiI = OneoverThetaPhiI_lin
    ...
    save('PINGING_Types11BifDiagFullVaryPhiI5.mat', 'phiI', 'phiE', 'f5', 'f4', 'f3', 'f2', 'f1', 'OneoverThetaPhiI_lin', 'thetaVI', 'gammaI', 'I_E', 'thetaPhiE', 'thetaVE', 'gammaE', 'epsilonII', 'epsilonIE', 'epsilonEI', 'tau');
end
